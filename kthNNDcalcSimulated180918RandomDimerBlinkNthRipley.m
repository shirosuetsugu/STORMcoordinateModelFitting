function [SimAv, SimUpSD, SimLwSD, Av, UpSD, LwSD, edges]=kthNNDcalcSimulated180918RandomDimerBlinkNthRipley(FileName2, MaxNeighbor,ObservationRate, Dist1stN,Dist2ndN,DAngle,  NoTrial, PopulationVector, edges, Accu)
% ObservationRate=0.5;
% tiltAngleX=40;
% tiltAngleZ=40;
% 
...
[SimAv, SimUpSD, SimLwSD]=kthNNDcalcRandomDimerBlinkNth180918Ripley(FileName2, data10, MaxNeighbor, edges, NoTrial,ObservationRate, Dist1stN,Dist2ndN,DAngle,PopulationVector, Accu);
...
Title1=[name ' 3D-NthNeighbor-Riepley-Simulated-ratio- '];
Title2=[  num2str(MaxNeighbor) 'MN-'  num2str(Ld) 'signals-' num2str(ObservationRate) 'ObsR-' num2str(Dist1stN) 'nm-' ...
    num2str(Dist2ndN) 'nm-' num2str( DAngle) ];
title({Title1, Title2})

FigName=[pwd filesep name '-3D-NthNeighbor-Simulated-ratio-'  num2str(Ld) '-signals-' num2str(ObservationRate) '-' num2str(Dist1stN) '-' ...
    num2str(Dist2ndN) '-' num2str( DAngle)  '.pdf'];
